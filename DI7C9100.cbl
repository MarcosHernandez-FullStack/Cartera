      ...
      *___________________                                              01160000
           MOVE '00'                                  TO W9100-CODRETOR. 01170002
           MOVE SPACES                                TO W9100-REFERENC. 01180020
           MOVE 'CNE0141'                             TO W9100-DIRCAPLN. 01181020
                                                                        01190000
           IF  (W9100-CODIGO NOT NUMERIC)                                01200000
                MOVE '08'                             TO W9100-CODRETOR  01210000
                MOVE 'ERROR CODIGO NO NUMERICO'       TO W9100-REFERENC  01220013
                MOVE 'DIE9108'                        TO W9100-DIRCAPLN  01221020
                PERFORM 900-FIN-PROGRAMA                                01230000
           END-IF.                                                      01240000
                                                                        01250000
           IF  (W9100-CODSER = 50)                                       01260018
                CONTINUE                                                01261018
           ELSE                                                         01262018
                MOVE '09'                             TO W9100-CODRETOR  01270016
                MOVE 'ERROR CODIGO NO VALIDO  '       TO W9100-REFERENC  01280016
                MOVE 'DIE9109'                        TO W9100-DIRCAPLN  01281020
      ...
      *_____________________________
           ...
           IF W9100-INDPAGI = 'S'
                IF W9100-PAGSIZE IS NUMERIC AND
                   W9100-PAGSIZE > 0        AND
                   W9100-PAGSIZE <= 200
                     MOVE W9100-PAGSIZE                TO WS-MAXITEM
                END-IF
           ELSE
                MOVE SPACES                            TO W9100-PAGINAC
           END-IF.
                                                                        01330000
       110-POSICIONA-PRIMERO.                                           01340000
      *_____________________                                            01350000
           IF W9100-INDPAGI = 'S' AND W9100-PAGINAC NOT = SPACES
                MOVE W9100-CODIGO                     TO WS-CODIGO
                MOVE W9100-PAGINAC(1:33)              TO DIED-KEY
           ELSE
                MOVE W9100-CODIGO                           TO DIED-CODIGO    01360000
                                                         WS-CODIGO.     01370002
           ...
           WHEN DFHRESP(NOTFND)                                         01540000
                MOVE '97'                             TO W9100-CODRETOR  01550000
                MOVE 'ERROR DIDIEDES CLAVE NO EXISTE' TO W9100-REFERENC  01560013
                MOVE 'DIE9197'                        TO W9100-DIRCAPLN  01561020
                PERFORM 900-FIN-PROGRAMA                                01570000
           WHEN DFHRESP(NOTOPEN)                                        01580000
                MOVE '98'                             TO W9100-CODRETOR  01590000
                MOVE 'ERROR DIDIEDES CERRADO '        TO W9100-REFERENC  01600013
                MOVE 'DIE9198'                        TO W9100-DIRCAPLN  01601020
                PERFORM 900-FIN-PROGRAMA                                01610000
           WHEN OTHER                                                   01620000
                MOVE '99'                             TO W9100-CODRETOR  01630000
                MOVE 'ERROR DIDIEDES STARTBR '        TO W9100-REFERENC  01640013
                MOVE 'DIE9199'                        TO W9100-DIRCAPLN  01641020
      ...
      *    CUYA CLAVE SE USO PARA REPOSICIONAR EL STARTBR (GTEQ).
           ...
           WHEN OTHER                                                   02330000
                MOVE '96'                             TO W9100-CODRETOR  02340000
                MOVE 'ERROR DIDIEDES READNEXT'        TO W9100-REFERENC  02350013
                MOVE 'DIE9196'                        TO W9100-DIRCAPLN  02351020
      ...
      *__________________                                               01690000
           ...
           PERFORM 210-OBTIENE-DATOS UNTIL                              01740000
                   ...
                   N                >= WS-MAXITEM.                      01770000
                                                                        01780016
           IF WS-FIN = 1
                MOVE 'N'                               TO W9100-INDPAGI
                MOVE SPACES                            TO W9100-PAGINAC
           ELSE
                MOVE 'S'                               TO W9100-INDPAGI
                MOVE DIED-KEY                          TO W9100-PAGINAC(1:33)
           END-IF.

           MOVE    WS-MAXITEM                          TO W9100-PAGSIZE

           MOVE    N                                  TO W9100-N         01790000
                                                                        01800000
           ...
           WHEN DFHRESP(NORMAL)                                         01870000
                CONTINUE                                                01880000
           WHEN OTHER                                                   01890000
                MOVE '91'                             TO W9100-CODRETOR  01900000
                MOVE 'ERROR DIDIEDES ENDBR   '        TO W9100-REFERENC  01910013
                MOVE 'DIE9191'                        TO W9100-DIRCAPLN  01911020
           ...
           WHEN DFHRESP(NORMAL)                                         02180000
                ...
                ELSE                                                    02220000
                   ...
                   IF WS-CODIGO-LEOS = 0                                02240000
                      MOVE '97'                       TO W9100-CODRETOR  02250000
                      MOVE 'ERROR DIDIEDES CODIGO NO EXIST'             02260013
                                                      TO W9100-REFERENC  02270000
                      MOVE 'DIE9197'                  TO W9100-DIRCAPLN  02271020
      ...
      *________________________                                         02470000
           MOVE  WS-CODIGO                         TO W9100-CODIGO-TIT.  02480000
           MOVE 'DESCUENTO DE LETRAS '             TO W9100-SERVICIO-TIT.02490007
           IF    WS-CODMON = 1 MOVE 'SOLES   '     TO W9100-MONEDA-TIT.  02500000
           IF    WS-CODMON = 2 MOVE 'DOLARES '     TO W9100-MONEDA-TIT.  02510000
                                                                        02520000
       260-LLENA-SALIDA-DETALLE.                                        02530000
      *________________________                                         02540000
           ADD  1                                  TO N.                02550000
           MOVE DIED-FECOPE                        TO W9100-FECOPE (N).  02560000
      *____TOTAL ABONADO______________________________________________  02561019
           MOVE DIED-INGRESO                       TO W9100-ABONOS (N).  02562019
      *____TOTAL CARGADO______________________________________________  02570000
           MOVE DIED-IMPORTE                       TO W9100-CARGOS (N).  02580019
                                                                        02610000
